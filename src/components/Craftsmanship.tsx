      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-12 space-y-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-2xl border-2 border-[#e6dac1] dark:border-[#d4af37]/40 aspect-[4/3] bg-[#000000]">
            ...
            <div className="absolute bottom-6 left-6 right-6 p-6 rounded-2xl bg-white/95 dark:bg-[#0a0805]/95 backdrop-blur-md border border-[#e6dac1] dark:border-[#d4af37]/50 space-y-1 shadow-2xl">
              <span className="text-[10px] font-bold text-[#8c1d1e] dark:text-[#fde047] uppercase tracking-widest block font-sans">
                Sariya Karigar Legacy
              </span>
              <h4 className="text-base font-serif font-bold text-[#1a1612] dark:text-[#fde047]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {pillars.map((pillar, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="p-6 rounded-2xl bg-[#faf6ee] dark:bg-[#0a0805] border-2 border-[#e6dac1] dark:border-[#d4af37]/40 space-y-3 shadow-md hover:border-[#b8860b] dark:hover:border-[#fde047] transition-all"
                >
                  <div className="w-12 h-12 rounded-xl bg-[#f4ebd0] dark:bg-[#1c160a] border border-[#b8860b]/30 dark:border-[#d4af37]/50 flex items-center justify-center text-[#8c1d1e] dark:text-[#fde047]">
